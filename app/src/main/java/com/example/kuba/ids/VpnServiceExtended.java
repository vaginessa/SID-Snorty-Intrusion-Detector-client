...
public class VpnServiceExtended extends VpnService implements Handler.Callback, Runnable {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (extras != null) {
            ...
            toast.makeText(context, "Server parameters specification error", duration).show();
            return START_STICKY;
        }
    ...
    private boolean runVpnConnection() throws Exception {
       // configure();
        ...
        try {
            Log.i(TAG, "Starting");
            InetSocketAddress server = new InetSocketAddress(mHost, mPortNumber);
            ...
            for (int attempt = 0; attempt < 10; ++attempt) {
                ...
                Log.i(TAG, attempt + 1 + " trial failed");
...
*/
    ...
    */
    ...
    private void configure(String parameters) throws Exception {
        ...
        mInterface = builder.setSession(mHost)
